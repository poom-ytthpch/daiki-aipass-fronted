...
const responseHeaders=['content-type','content-disposition','cache-control','retry-after','x-accel-buffering','x-daiki-request-id','x-daiki-access-mode','x-daiki-inference-upstream','x-daiki-quota-mode','x-daiki-quota-remaining','x-daiki-quota-reset','x-daiki-research-used','x-daiki-research-sources','x-daiki-research-sources-json','x-daiki-research-quality','x-daiki-research-quality-grade','x-daiki-research-mode','x-daiki-command-mode','x-daiki-command-skills','x-daiki-model-alias','x-daiki-skills','x-daiki-tools','x-daiki-thinking-mode','x-daiki-token-estimate-input','x-daiki-token-estimate-thinking','x-daiki-token-estimate-output','x-daiki-token-estimate-total','x-daiki-model-physical','x-daiki-retry-attempts','x-daiki-context-trimmed','x-daiki-fallback-model','x-daiki-reasoning-requested','x-daiki-reasoning-effective','x-daiki-reasoning-native','x-daiki-reasoning-model','x-daiki-hermes-profile'];
