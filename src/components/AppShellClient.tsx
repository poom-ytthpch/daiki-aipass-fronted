  ...
  return <div className={`shell appShell ${collapsed?'shellCollapsed':''}`}>
    ...
    <aside className={`sidebar appSidebar ${drawer?'drawerOpen':''}`}>
      <div className="sidebarHeader">
        ...
        <button className="collapseButton" type="button" aria-label={collapsed?'Expand sidebar':'Collapse sidebar'} onClick={toggleCollapsed}>{collapsed?<ChevronRight size={17}/>:<ChevronLeft size={17}/>}</button>
